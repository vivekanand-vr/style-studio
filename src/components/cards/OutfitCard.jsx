    ...
    >
      ...
      <div className="absolute top-3 right-3 flex gap-1 z-10">
        <button
          ...
          className="p-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm text-gray-600 dark:text-gray-400 rounded-full hover:bg-white dark:hover:bg-gray-800 transition-colors shadow-lg"
          title="Edit Outfit"
        >
          <Edit2 size={16} />
        </button>
        <button
          ...
          className="p-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm text-gray-600 dark:text-gray-400 rounded-full hover:bg-white dark:hover:bg-gray-800 hover:text-red-500 transition-colors shadow-lg"
          title="Delete Outfit"
        >
          <Trash2 size={16} />
        </button>
      ...
      <div className="p-5">
        ...
        {items.length > 0 && (
          <div className="flex -space-x-2">
            ...
            {items.length > 4 && (
              <div className="w-10 h-10 rounded-full border-2 border-white dark:border-gray-800 bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center text-xs font-semibold text-indigo-600 dark:text-indigo-400">
                +{items.length - 4}
              </div>
            )}
          </div>
